...
class THEMIS_KIND(DefaultParty):

    def __init__(self):
        super().__init__()
        self._best_bids_so_far = []
        self._prop_outcome = 0.5
        ...
        self._c1 = Decimal(0.8)
        self._c2 = Decimal(0.5)
        self._c3 = Decimal(0.7)
        ...
        self._kindness = 0
        self._kindness_threshold_to_concede = 0.25       # GIVEN IN ABSOLUTE TERMS SO NON-NEGATIVE
        self._x_train = []
        ...
        self._cmax = 0.08/self._prop_outcome            # MAXIMUM CONCESSION EACH ROUND
